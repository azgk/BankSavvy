...
## Program Output
<img alt="A screenshot of program output (deposits summary) example." src="program output/program_output_summary_dep.png" title="Program Output(deposits summary)" width="80%"/>
<img alt="A screenshot of program output (expenses summary) example." src="program output/program_output_summary_exp.png" title="Program Output(expenses summary)" width="80%"/>
